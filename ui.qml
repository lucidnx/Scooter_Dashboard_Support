                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    CheckBox { id: secretExitOnLock; text: "Enabled"; spacing: 4; indicator: Rectangle { implicitWidth: 21; implicitHeight: 21; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 7; color: parent.checked ? "#ec6e1c" : "transparent"; border.width: 2; border.color: parent.checked ? "#ec6e1c" : "#4a4a52"; Behavior on color { ColorAnimation { duration: 120 } } Rectangle { x: 4.25; y: 11.15; width: 6.0; height: 3.2; radius: 1.6; rotation: 45; color: "#ffffff"; opacity: parent.parent.checked ? 1 : 0 } Rectangle { x: 6.7; y: 9.4; width: 11.6; height: 3.2; radius: 1.6; rotation: -45; color: "#ffffff"; opacity: parent.parent.checked ? 1 : 0 } } }
                                }
