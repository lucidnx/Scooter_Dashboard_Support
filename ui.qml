                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    ComboBox {
                                        ...
                                        popup.padding: 6
                                        Component.onCompleted: popup.contentItem.boundsBehavior = Flickable.StopAtBounds
                                        delegate: comboItem
                                    }
                                }
                                ...
                                RowLayout {
                                    ...
                                    CheckBox { id: secretExitOnLock; spacing: 4; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                }
                                ...
                                RowLayout {
                                    ...
                                    CheckBox { id: lightOnBoot; spacing: 4; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                }

                                RowLayout {
                                    Layout.fillWidth: true
                                    Label { text: "Always ON Tail Light"; Layout.fillWidth: true; enabled: rearLightEnable.checked }
                                    CheckBox { id: autoTaillight; spacing: 4; enabled: rearLightEnable.checked; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                }
                                ...
                                RowLayout {
                                    ...
                                    CheckBox { id: showBatteryInIdle; text: "Normal"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                    CheckBox { id: showBatterySecret; text: "Secret"; spacing: 4
                                        enabled: secretEnabled.checked
                                        padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                }
                                ...
                                RowLayout {
                                    ...
                                    CheckBox { id: alarmTone; spacing: 4; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                }
                            ...
                            ColumnLayout {
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        Layout.fillWidth: true
                                        spacing: 6
                                        CheckBox { id: lockBrake; text: "Brake"; checked: true; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        CheckBox { id: lockThrottle; text: "Throttle"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        Layout.fillWidth: true
                                        spacing: 6
                                        CheckBox { id: modeBrake; text: "Brake"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        CheckBox { id: modeThrottle; text: "Throttle"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        CheckBox { id: modeLocked; text: "Locked"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        Item { Layout.fillWidth: true }
                                    }
                                }
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        Layout.fillWidth: true
                                        spacing: 6
                                        CheckBox { id: lightBrake; text: "Brake"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        CheckBox { id: lightThrottle; text: "Throttle"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        CheckBox { id: lightLocked; text: "Locked"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        Item { Layout.fillWidth: true }
                                    }
                                }
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        CheckBox { id: secretThrottle; text: "Throttle"; checked: true; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        Layout.fillWidth: true
                                        spacing: 6
                                        CheckBox { id: secretOffBrake; text: "Brake"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        CheckBox { id: secretOffThrottle; text: "Throttle"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        CheckBox { id: secretOffRequiresLock; text: "Locked"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        Item { Layout.fillWidth: true }
                                    }
                                }
                            }
                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    Item { Layout.preferredWidth: 121 }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applySpeed; text: "Speed"; checked: true; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applyCurrent; text: "Current %"; checked: true; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applyWatts; text: "Watts"; checked: true; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applyFw; text: "Field Weak."; checked: true; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applyOm; text: "Overmod."; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    CheckBox { id: secretEnabled; spacing: 4; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplySpeed; text: "Speed"; checked: true; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplyCurrent; text: "Current %"; checked: true; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplyWatts; text: "Watts"; checked: true; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplyFw; text: "Field Weak."; checked: true; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplyOm; text: "Overmod."; Layout.preferredWidth: 121; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        CheckBox { id: softwareAdc; text: "Throttle"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                        CheckBox { id: softwareAdc2; text: "Brake"; spacing: 4; padding: 6; indicator: Item { } background: Rectangle { radius: 9; implicitHeight: 34; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                    }
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        CheckBox {
                                            ...
                                            indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } }
                                        }
                                    }
                                    ...
                                    RowLayout {
                                        ...
                                        CheckBox { id: bmsSoc; spacing: 4; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                    }
                                    ...
                                    RowLayout {
                                        ...
                                        CheckBox { id: appEnable; spacing: 4; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                    }
                                    ...
                                    RowLayout {
                                        ...
                                        CheckBox { id: rearLightEnable; spacing: 4; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                    }
                            ...
                            Rectangle {
                                ...
                                ColumnLayout {
                                    ...
                                    RowLayout {
                                        ...
                                        CheckBox { id: cruiseEnable; spacing: 4; indicator: Rectangle { implicitWidth: 40; implicitHeight: 22; x: parent.leftPadding; y: parent.height / 2 - height / 2; radius: 11; color: parent.checked ? "#ec6e1c" : "#3d3d44"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } Rectangle { y: 3; width: 16; height: 16; radius: 8; color: "#ffffff"; x: parent.parent.checked ? 21 : 3; Behavior on x { NumberAnimation { duration: 140; easing.type: Easing.OutCubic } } } } }
                                    }
