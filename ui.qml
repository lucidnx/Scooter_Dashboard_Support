                    ...
                    ColumnLayout {
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applySpeed; text: "Speed"; checked: true; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applyCurrent; text: "Current %"; checked: true; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applyWatts; text: "Watts"; checked: true; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applyFw; text: "Field Weak."; checked: true; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: applyOm; text: "Overmod."; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplySpeed; text: "Speed"; checked: true; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplyCurrent; text: "Current %"; checked: true; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplyWatts; text: "Watts"; checked: true; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplyFw; text: "Field Weak."; checked: true; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    CheckBox { id: secretApplyOm; text: "Overmod."; Layout.preferredWidth: 112; topPadding: 0; bottomPadding: 0; leftPadding: 4; rightPadding: 4; indicator: Item { } background: Rectangle { radius: 8; implicitHeight: 28; color: parent.checked ? "#ec6e1c" : "#2b2b31"; opacity: parent.enabled ? 1 : 0.45; Behavior on color { ColorAnimation { duration: 140 } } } contentItem: Label { text: parent.text; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; elide: Text.ElideRight; font.bold: true; font.pointSize: root.titleSize * 0.9; color: parent.checked ? "#1d1206" : "#8a8a92" } }
